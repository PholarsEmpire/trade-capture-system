...
INSERT INTO application_user (id, first_name, last_name, login_id, password, active, user_profile_id, version, last_modified_timestamp) VALUES
  (1000, 'Alice', 'Smith', 'alice', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1002, 1, '2025-06-02T00:00:00'),
  (1001, 'Bob', 'Jones', 'bob', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1001, 1, '2025-06-02T00:00:00'),
  (1003, 'Simon', 'King', 'simon', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1000, 1, '2025-06-02T00:00:00'),
  (1004, 'Ashley', 'Lovegood', 'ashley', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1003, 1, '2025-06-02T00:00:00'),
  (1005, 'Joey', 'Tribbiani', 'joey', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1000, 1, '2025-06-02T00:00:00'),
  (1006, 'Stuart', 'McGill', 'stuart', '$2a$10$slYQmyNdGzTn7ZLBXBChFOC9f6kFjAqPhccnP6DxlWXx2lPk1C3G6', true, 1004, 1, '2025-06-02T00:00:00');
...
INSERT INTO user_privilege (user_id, privilege_id) VALUES (1000, 1000), (1001, 1002), (1000, 1002), (1003, 1000), (1003, 1001), (1003, 1002), (1004, 1001), (1004, 1002), (1005, 1000), (1005, 1001), (1005, 1002);
...
-- Sample Settlement Instructions (Additional Info)
INSERT INTO additional_info (id, entity_type, entity_id, field_name, field_value, field_type, active, version, created_date, last_modified_date, deactivated_date) VALUES
  (1000, 'TRADE', 100001, 'SETTLEMENT_INSTRUCTIONS', 'Pay via Bank ABC, Account: 12345-67890, SWIFT: ABCGB2LXXX, Reference: TRADE-100001', 'STRING', true, 1, '2024-06-01T10:30:00', '2024-06-01T10:30:00', null),
  (1001, 'TRADE', 100002, 'SETTLEMENT_INSTRUCTIONS', 'Pay via HSBC London, Account: 98765-43210, SWIFT: HSBCGB2LXXX, Reference: TRADE-100002', 'STRING', true, 1, '2024-06-02T11:15:00', '2024-06-02T11:15:00', null);
